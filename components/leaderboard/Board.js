            ...
            <div className="inline-block min-w-full py-12 align-middle sm:px-6 lg:px-8">
              <table className="min-w-full text-left divide-y divide-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                    {deals.map((deal) => (
                        <tr key={deal.id}>
                        <td className="whitespace-nowrap py-9 pr-3 text-sm sm:pl-0">
                        ...
                        <td className="whitespace-nowrap py-5 px-3 text-sm text-gray-500">
                        ...
                        <td className="whitespace-nowrap py-5 px-3 text-sm text-gray-500">{deal.commission}%</td>
