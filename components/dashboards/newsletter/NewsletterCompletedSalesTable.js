...
const NewsletterCompletedSalesTable = ({ user }) => {
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-gray-900">Your completed sales!</h1>
            ...
            <thead className="bg-gray-50" >
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {completedSales.map((completedSale) => (
                  <tr key={completedSale.id}>
                    <td className="whitespace-nowrap py-2 pl-4 pr-3 text-sm text-gray-500 sm:pl-0">{completedSale.dollarAmount}</td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">
                      {completedSale.time}
                    </td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{completedSale.commission}</td>
                    <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                      <a href="#" className="text-indigo-600 hover:text-indigo-900">
                        Edit<span className="sr-only">, {completedSale.id}</span>
                      </a>
                    </td>
                  </tr>
                ))}
...
export default NewsletterCompletedSalesTable;
