...
export default function Example() {
  ...
  const scrollHalfPage = () => {
    console.log("hereheeeeeeee");
    const halfPageHeight = window.innerHeight * 20;
    window.scrollBy({ top: halfPageHeight, left: 0, behavior: 'smooth' });
  };
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
              <Link key={"Leaderboard"}href={"#"} onClick={scrollHalfPage} className="text-sm font-semibold leading-6 text-gray-900">
                Leaderboard
              </Link>
              <Link key={"Dashboard"} href={"/dashboardPage"} className="text-sm font-semibold leading-6 text-gray-900">
                Dashboard
              </Link>
          </div>
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                    Weelcome to honeypot were changing blah blah
                  </h1>
